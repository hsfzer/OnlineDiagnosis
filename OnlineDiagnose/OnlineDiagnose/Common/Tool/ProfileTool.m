...
@implementation ProfileTool {
    NSUInteger maxMemory;
    NSUInteger minMemory;
}
...
- (vm_size_t)getUsedMemory
{
    ...
    {
        maxMemory < info.resident_size ? maxMemory = info.resident_size:0;
        minMemory > info.resident_size ? minMemory = info.resident_size:0;
